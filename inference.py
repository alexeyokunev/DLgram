...
def inference(path, net, thresh):
    ...
    res_json = predict(path_to_cfg, path_to_ckpt, classes, img, thresh)
...
if __name__ == '__main__':
    ...
    parser.add_argument("-n", "--net", default='lp2', help="unique name for network model, \"sph\" for spheres, \"stm\" for stm etc")
    ...
    inference(args.path, args.net, args.thresh)